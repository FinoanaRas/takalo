...
CREATE TABLE proposition(
    id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    idObjet1 INT NOT NULL, --demandeur
    idObjet2 INT NOT NULL, --demande
    status INT NOT NULL,
    foreign key (idObjet1) references objets(id),
    foreign key (idObjet2) references objets(id)
);

INSERT INTO proposition VALUES(1, 1, 3, 5);   --en cours
INSERT INTO proposition VALUES(2, 2, 4, 10);  --accepte
INSERT INTO proposition VALUES(3, 1, 4, 0);   --refuse